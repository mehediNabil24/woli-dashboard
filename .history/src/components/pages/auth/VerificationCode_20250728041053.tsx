...
export default function VerificationCode() {
  ...
  const verifyEmailToken = searchParams.get("verifyEmail");
  const navigate = useNavigate()
    useEffect(() => {
    if (verifyEmailToken) {
      setEmail(verifyEmailToken);
    }
  }, [verifyEmailToken]);
  ...
  return (
    <div>
      <MenuItem />
      <div className="min-h-screen bg-[#000000] flex  justify-center p-4">
        {/* <Link>
         <h1 className="text-2xl  text-white tracking-wide -mt-96 mr-34">
          Back
         </h1>
          </Link> */}
        <div className="w-full max-w-md space-y-8 text-center mt-20">
