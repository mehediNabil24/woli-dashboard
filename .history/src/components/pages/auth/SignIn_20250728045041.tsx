    ...
    <div>
      ...
      <div className="w-full min-h-screen flex lg:items-center justify-center bg-black pt-6">
        <div className="lg:min-w-[500px] h-full mx-auto">
          ...
          {/* IMPORTANT: Use handleSubmit(onSubmit) directly */}
          <form
          ...
          >
            ...
            <div className="space-y-2">
              <label
                htmlFor="email"
                className="text-sm font-medium block text-white"
              >
                Email address
              </label>
              <input
                ...
                {...register("email")}
                className={`w-full text-white px-3 py-2 border ${
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  {...register("password")}
                  className={`w-full px-3 py-2 text-white border ${
