...
const [verificationEmail,{isLoading}]=useVerifyEmailMutation()
  ...
  const handleSubmit = () => {
    try {
      ...
      const res = verificationEmail(verificationCode).unwrap()
      console.log(res,"res");
      if(res?.success){
        ...
        <div className="w-full max-w-md space-y-8 text-center">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Enter 6 digit code what sended to your email dh****@gmail.com
            </p>
          </div>
