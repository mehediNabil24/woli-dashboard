    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-black">
      <div className="lg:min-w-[500px] h-full mx-auto">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-[56px] font-bold mb-2 text-white uppercase">Welcome Back!</h1>
          <p className="text-[56px] font-bold text-[#FECD1C] uppercase">Sign in to your account</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                className={`w-full px-3 py-2 text-white border border-[#E6E6E6] ${errors.password ? "border-red-500" : "border-gray-200"
                  } rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500`}
              />
              <button
                type="button"
