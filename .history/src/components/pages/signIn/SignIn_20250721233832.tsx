    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-black">
      <div className="lg:min-w-[500px] h-full mx-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full">
          ...
          <button
            type="submit"
            className="w-full cursor-pointer bg-[#FECD1C] text-black font-s py-2 px-4 rounded-md hover:bg-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            disabled={isLoading}
          >
