...
import { useAddDocumentMutation, useDeleteDocumentQuery } from "../../../redux/features/profile/profileApi";
import { toast } from "sonner";

const DocumentAdd = ({ documentAgent }:any) => {
  const [fileList, setFileList] = useState<UploadFile[]>([]);
  const [addDocument, { isLoading }] = useAddDocumentMutation();
const [deleteDocument] = useDeleteDocumentQuery()
