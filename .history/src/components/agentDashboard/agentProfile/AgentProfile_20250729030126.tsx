...
const [imageSrc, setImageSrc] = useState("/default.png"); 
  ...
  const handleProfileUpdate = (updatedData: any) => {
    setProfileInfo({
      ...
      homeAddress: updatedData.address.homeAddress,
  ...
  return (
    <div className=" flex justify-center items-start">
      ...
      <img src={imageSrc} alt="Profile" className="w-full h-full object-cover rounded-md" />
      <div
        onClick={handleImageClick}
        className="absolute top-0 right-0 bg-white h-10 w-10 flex items-center justify-center rounded-full p-1 shadow cursor-pointer"
      >
      ...
      />
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-1">Rank ( {userData?.level || "1"})</h3>
