      ...
      <div className="p-6">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="col-span-full flex justify-center items-center flex-col gap-2">
            <div className="relative w-28 h-28 rounded-full overflow-hidden shadow-md border border-gray-300 cursor-pointer">
              <img
              ...
              <label
                ...
                className="absolute bottom-0 right-0 bg-black text-white text-xs px-2 py-1 rounded-tr-lg cursor-pointer"
              >
                Edit
              </label>
              <input
