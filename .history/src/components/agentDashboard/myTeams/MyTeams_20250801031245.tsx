...
import { Table, Input, Select, Pagination, Avatar, Button } from "antd"
            ...
            <div className="bg-white rounded-lg shadow-sm">
                ...
                <div className="flex items-center justify-end p-4 space-x-4">
                    <Input
                        ...
                        size="middle"
                    />
                     <Button variant="outline" className="flex items-center gap-2 bg-transparent !border-[#FECD1C] !text-black font-medium">
        <Plus className="h-4 w-4" />
        Invite Team Members
      </Button>
      <Button className="bg-yellow-400 hover:bg-yellow-500 text-black">Create Team</Button>
                </div>
                {/* Table Section */}
