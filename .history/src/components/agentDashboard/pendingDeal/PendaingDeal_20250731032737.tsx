    ...
    },
    {
      ...
      render: (_, record) => (
        <Dropdown
          overlay={
            <Menu>
              <Menu.Item key="edit" onClick={() => handleEditClick(record.id)}>
                Edit
              </Menu.Item>
            </Menu>
          }
        ...
        initialData={
          editingRecord
            ? {
                ...
                clientFirstName: editingRecord.clientName.split(" ")[0],
                clientLastName: editingRecord.clientName.split(" ")[1] || "",
                applicationNumber: editingRecord.applicationNo,
                annualPremium: editingRecord.annualPremi,
                note: "Written by agent thought",
              }
            : undefined
        }
      />
