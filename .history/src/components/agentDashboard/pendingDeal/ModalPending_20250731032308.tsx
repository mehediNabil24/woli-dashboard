...
export default function EditDealModal({ visible, onCancel, initialData }: EditDealModalProps) {
  ...
  const defaultData = initialData || {
    ...
    clientFirstName: "",
    clientLastName: "Son",
    applicationNumber: "#Fafl545411",
    annualPremium: "$122,548",
    note: "Wroten by agent thought",
  }
      ...
      <div className="p-6">
        <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div>
            ...
            <Select id="agentName" defaultValue={defaultData.agentName} className="w-full" size="large">
